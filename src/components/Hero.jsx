    ...
    <div id="hero" className="min-h-screen flex flex-col justify-center max-w-6xl mx-auto px-8" style={{paddingTop: '56px'}}>
      <div className="max-w-3xl">
        ...
        <p className="text-2xl text-gray-500 leading-relaxed mb-12">
          A roadmap to grow guest ATPU by turning great trips into trusted relationships — for the guests who need Turo most.
        </p>
        ...
        <div className="flex items-center gap-12">
          ...
          <div>
            <p className="text-4xl font-medium" style={{color: '#231F20'}}>3</p>
            <p className="text-sm text-gray-400 mt-1">variables addressed</p>
          </div>
        </div>
      </div>
    </div>
